...
function install_prepare_software_on_centos()
{
    ...
    if [ $version -ge 8 ];then
        ...
        sudo dnf install -y vim ctags cscope automake gcc gcc-c++ kernel-devel make cmake python2 python2-devel python3-devel fontconfig ack git
    else
        sudo yum install -y ctags cscope automake gcc gcc-c++ kernel-devel cmake python-devel python3-devel fontconfig ack git
...
{
    sudo dnf install -y vim ctags cscope automake gcc gcc-c++ kernel-devel cmake python-devel python3-devel fontconfig ack git
}
